...
/// </summary>
public readonly struct ScoreboardRangeMatch : IEquatable<ScoreboardRangeMatch>, IScoreboardRange
{
    /// <summary>
    ...
    /// </summary>
    public IntegralRange Range { get; }

    /// <inheritdoc />
    public readonly bool Equals(ScoreboardRangeMatch other)
    {
#if DEBUG
