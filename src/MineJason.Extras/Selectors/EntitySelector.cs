...
public sealed class EntitySelector(EntitySelectorKind kind) : IEquatable<EntitySelector>, IEntitySelector
{
    /// <summary>
    ...
    /// </summary>
    public EntityNameMatchCollection Name { get; } = [];
    ...
    /// <summary>
    /// Initiates the construction of a target selector that selects the nearest entity from the position of 
    /// execution.
    /// </summary>
    /// <returns>A new instance of the <see cref="EntitySelectorBuilder"/> class.</returns>
    public static EntitySelectorBuilder NearestEntity()
    {
        return new EntitySelectorBuilder(new EntitySelector(EntitySelectorKind.NearestEntity));
    }
}