...
public class EntitySelectorBuilder
{
    ...
    /// <summary>
    /// Adds the specified entity name rule.
    /// </summary>
    /// <param name="name">The name.</param>
    /// <param name="match">Whether the entity must have the name or must not have the name specified to be selected.</param>
    /// <returns>This instance.</returns>
    public EntitySelectorBuilder Name(string name, bool match = true)
    {
        _selector.Name.Add(new EntityNameMatch(name, match));
        return this;
    }

    /// <summary>
    /// Adds a rule that requires an entity to have the specified name from being selected.
    /// </summary>
    /// <param name="name">The name to match.</param>
    /// <returns>This instance.</returns>
    public EntitySelectorBuilder HasName(string name)
    {
        _selector.Name.Add(new EntityNameMatch(name, true));
        return this;
    }
    ...
    {
        _selector.Name.Add(new EntityNameMatch(name, false));
        return this;
    }
    ...
    /// <returns>This instance.</returns>
    public EntitySelectorBuilder IncludeNbt(INbtDataProvider nbt)
    {
    ...
    /// <param name="nbt">The NBT.</param>
    /// <returns>This instance.</returns>
    public EntitySelectorBuilder ExcludeNbt(INbtDataProvider nbt)
    {
